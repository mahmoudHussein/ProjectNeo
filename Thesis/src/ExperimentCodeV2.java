...
//				System.out.println(systemsSt);
	...
	public static ArrayList<String> SingleSequance(String[][] connectionsArray, String CurrentObjId, ArrayList<String> sequance, int elementCounter ){
		...
		for(int k = 0; k < connectionsArray.length; k++){
			if(connectionsArray[k][0] != null && connectionsArray[k][0].equals(currentObject)){
				...
				connectionsArray[k][2].equals("CT_LEADS_TO_1")|| connectionsArray[k][2].equals("CT_CRT_1")){
					...
					elementCounter++;
					SingleSequance(connectionsArray, currentObject, sequance, elementCounter);
					break;
			}
	...
	public static String[][] MultiSequance(String[][] ObjectInfo, String[][] connectionsArray){
		...
		for (int i = 0 ; i < startEvents.size(); i++){
			...
			tempSequance =  SingleSequance(connectionsArray, currentStartEventID, tempSequance, elementCounter );
			System.out.println("Conv  "+ tempSequance);
...
//				File fXmlFile = new File("C:\\Users\\User\\Desktop\\gam3a\\7th semester\\eclipse\\Aris code testing\\testing1smlgen2.xml");
			 ...
			 //-----------------------------------------------------------------------------------------------------------------------------------------------
				String[][] ObjectInfo = new String [50][5];
...
//				  TokenData(objectsIDOfTheConnections,ObjectInfo, AddInfoArray,taskIndex, connectionsArray);
				  MultiSequance(ObjectInfo, connectionsArray);
